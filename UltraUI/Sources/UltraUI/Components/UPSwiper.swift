...
public struct UPSwiper: View {
    ...
    private var currentBinding: Binding<Int>?; private var onChangeHandler: ((Int) -> Void)?; private var onClickHandler: ((Int) -> Void)?
    public init(list: [String] = [], indicator: Bool = false, indicatorActiveColor: String = "#FFFFFF", indicatorInactiveColor: String = "rgba(255, 255, 255, 0.35)", indicatorStyle: UPStyle = UPStyle(), indicatorMode: String = "line", autoplay: Bool = true, current: Int = 0, interval: Int = 3000, duration: Int = 300, circular: Bool = false, vertical: Bool = false, previousMargin: some UPImageUnitValue = "0", nextMargin: some UPImageUnitValue = "0", acceleration: Bool = false, displayMultipleItems: Int = 1, easingFunction: String = "default", keyName: String = "url", imgMode: String = "aspectFill", height: some UPImageUnitValue = "130", bgColor: String = "#f3f4f6", radius: some UPImageUnitValue = "4", loading: Bool = false, showTitle: Bool = false) {
        self.init(list: list.map { UPSwiperItem(source: $0) }, indicator: indicator, indicatorActiveColor: indicatorActiveColor, indicatorInactiveColor: indicatorInactiveColor, indicatorStyle: indicatorStyle, indicatorMode: indicatorMode, autoplay: autoplay, current: current, interval: interval, duration: duration, circular: circular, vertical: vertical, previousMargin: previousMargin, nextMargin: nextMargin, acceleration: acceleration, displayMultipleItems: displayMultipleItems, easingFunction: easingFunction, keyName: keyName, imgMode: imgMode, height: height, bgColor: bgColor, radius: radius, loading: loading, showTitle: showTitle)
    }

    public init(list: [UPSwiperItem] = [], indicator: Bool = false, indicatorActiveColor: String = "#FFFFFF", indicatorInactiveColor: String = "rgba(255, 255, 255, 0.35)", indicatorStyle: UPStyle = UPStyle(), indicatorMode: String = "line", autoplay: Bool = true, current: Binding<Int>, interval: Int = 3000, duration: Int = 300, circular: Bool = false, vertical: Bool = false, previousMargin: some UPImageUnitValue = "0", nextMargin: some UPImageUnitValue = "0", acceleration: Bool = false, displayMultipleItems: Int = 1, easingFunction: String = "default", keyName: String = "url", imgMode: String = "aspectFill", height: some UPImageUnitValue = "130", bgColor: String = "#f3f4f6", radius: some UPImageUnitValue = "4", loading: Bool = false, showTitle: Bool = false) {
        self.init(list: list, indicator: indicator, indicatorActiveColor: indicatorActiveColor, indicatorInactiveColor: indicatorInactiveColor, indicatorStyle: indicatorStyle, indicatorMode: indicatorMode, autoplay: autoplay, current: current.wrappedValue, interval: interval, duration: duration, circular: circular, vertical: vertical, previousMargin: previousMargin, nextMargin: nextMargin, acceleration: acceleration, displayMultipleItems: displayMultipleItems, easingFunction: easingFunction, keyName: keyName, imgMode: imgMode, height: height, bgColor: bgColor, radius: radius, loading: loading, showTitle: showTitle, current: current)
    }
    public init(list: [UPSwiperItem] = [], indicator: Bool = false, indicatorActiveColor: String = "#FFFFFF", indicatorInactiveColor: String = "rgba(255, 255, 255, 0.35)", indicatorStyle: UPStyle = UPStyle(), indicatorMode: String = "line", autoplay: Bool = true, current: Int = 0, interval: Int = 3000, duration: Int = 300, circular: Bool = false, vertical: Bool = false, previousMargin: some UPImageUnitValue = "0", nextMargin: some UPImageUnitValue = "0", acceleration: Bool = false, displayMultipleItems: Int = 1, easingFunction: String = "default", keyName: String = "url", imgMode: String = "aspectFill", height: some UPImageUnitValue = "130", bgColor: String = "#f3f4f6", radius: some UPImageUnitValue = "4", loading: Bool = false, showTitle: Bool = false, current binding: Binding<Int>? = nil) {
        self.items = list; self.indicator = indicator; self.indicatorActiveColor = indicatorActiveColor; self.indicatorInactiveColor = indicatorInactiveColor; self.indicatorStyle = indicatorStyle; self.indicatorMode = indicatorMode; self.autoplay = autoplay; self.current = binding?.wrappedValue ?? current; self.currentBinding = binding; self.interval = interval; self.duration = duration; self.circular = circular; self.vertical = vertical; self.previousMargin = previousMargin.upImageUnitValue; self.nextMargin = nextMargin.upImageUnitValue; self.acceleration = acceleration; self.displayMultipleItems = displayMultipleItems; self.easingFunction = easingFunction; self.keyName = keyName; self.imgMode = imgMode; self.height = UPUnit.parse(height.upImageUnitValue); self.bgColor = bgColor; self.radius = UPUnit.parse(radius.upImageUnitValue); self.loading = loading; self.showTitle = showTitle
    }
    public var body: some View { TabView(selection: .constant(selectedIndex)) { ForEach(Array(items.enumerated()), id: \.element.id) { index, item in Text(item.title.isEmpty ? item.source : item.title).tag(index) } }.frame(height: height).background(UPColor.parse(bgColor)).clipShape(RoundedRectangle(cornerRadius: radius)) }
    private var selectedIndex: Int { items.isEmpty ? 0 : min(max(current, 0), items.count - 1) }
    public func select(_ index: Int) { guard items.indices.contains(index) else { return }; currentBinding?.wrappedValue = index; onChangeHandler?(index) }
    ...
    public func triggerClick(_ index: Int) { onClickHandler?(index) }
}
